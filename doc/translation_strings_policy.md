...
This document provides guidelines for internationalization of the Shavermacoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `shavermacoin_en.ts` remains unchanged.
