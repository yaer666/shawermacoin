...
Shavermacoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
Format: ```mngovernance prepare proposal-name url payment-count block-start shavermacoin-address monthly-payment-shavermacoin```
...
Format: ```mngovernance submit proposal-name url payment-count block-start shavermacoin-address monthly-payment-shavermacoin fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using shavermacoin.conf setup)
