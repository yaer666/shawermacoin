...
official/supported Docker Images found at https://hub.docker.com/r/shavermacoinpay/shavermacoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/shavermacoinpay/shavermacoind-develop/ when changing the above text**