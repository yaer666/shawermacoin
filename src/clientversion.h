...
//! These need to be macros, as clientversion.cpp's and shavermacoin*-res.rc's voodoo requires it
...
/**
 * shavermacoind-res.rc includes this file, but it cannot cope with real c++ code.
