...
#define BOOST_TEST_MODULE Shavermacoin Test Suite

#include "test_shavermacoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_shavermacoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
